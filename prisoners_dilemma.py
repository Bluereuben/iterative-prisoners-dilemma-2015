...
def get_action(player, history, opponent_history, score, opponent_score, getting_team_name=False):
    ...
    ###### team 0 use lines 116 to 140 (after the else)
    ######
    #
    ...
    ###### team 1 use lines 149 to 173 (after the else)
    ######
    #
    ...
    ###### team 2 use lines 183 to 207 (after the else)
    ######
    #   
    ...
    ###### team 3 use lines 215 to 239 (after the else)
    ######
    #
    elif player == 3:
        if getting_team_name:
    ...
    ###### team 4 use lines 247 to 271 (after the else)
    ######
    #
    elif player == 4:
        if getting_team_name:
    ...
    ###### team 5 use lines 279 to 303 (after the else)
    ######        
    #
    elif player == 5:
        if getting_team_name:
            return 'Ill take the plea bargin'
        else:
    ...
    ###### team 6 use lines 311 to 335 (after the else)
    ######        
    #
    elif player == 6:
        if getting_team_name:
    ...
    ###### team 7 use lines 343 to 367 (after the else)
    ######       
    #
    elif player == 7:
        if getting_team_name:
    ...
    ###### team 8 use lines 376 to 400 (after the else)
    ######        
    #
    elif player == 8:
        if getting_team_name:
    ...
    ###### team  use lines 408 to 432 (after the else)
    ######
    #
    elif player == 9:
        if getting_team_name:
